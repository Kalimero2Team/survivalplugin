package me.byquanton.survivalplugin.discord;

import me.byquanton.survivalplugin.SurvivalPlugin;
import me.byquanton.survivalplugin.database.pojo.DiscordUser;
...
public class DiscordBot implements MessageCreateListener, ServerMemberLeaveListener, MessageComponentCreateListener {
    ...
    public void removeDiscordUser(MinecraftUser user) {
        if(user != null){
            ...
            MinecraftUser finalMcuser = user;
            new BukkitRunnable(){
